...
class Boat(Transport):
    ...
    def start_engine(self):
        print('Заводи, мотор, детка. Золото близко')

    def stop_engine(self):
        print("Глуши тарахтелку. Приплыли")

    def move(self):
        print('Под всеми парусами. Вперед')
...
class Car(Transport):
    ...
    def start_engine(self):
        print('Дружище, зажигание проверни')

    def stop_engine(self):
        print("На ручник поставил? На скорость? Тогда выключай двигатель")

    def move(self):
        print('Поехали. На знаки только смотри')

    def stop(self):
        print('Притормози чутка')


class Electroscooter(Transport):

    def start_engine(self):
        print('Заводи, коли это не велосипед')

    def stop_engine(self):
        print("Выключай мотороллер")

    def move(self):
        print('Пошуршали. На этом странном велосипеде без педалей.')

    def stop(self):
        print('Про тормоз не забывай, лихач.')


class Person:

    @staticmethod
    def use_transport(transport_interface):
        transport_interface.start_engine()
        transport_interface.stop_engine()
        transport_interface.move()
        transport_interface.stop()
